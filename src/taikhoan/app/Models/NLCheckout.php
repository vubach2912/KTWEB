...
class NLCheckout
{
    ...
    public $merchant_site_code = '47771'; //100001 chỉ là ví dụ, bạn hãy thay bằng mã của bạn
    // Mật khẩu giao tiếp giữa website của bạn và NgânLượng.vn.
    public $secure_pass = 'bdc15acc06c0ab823fcd3be9abddb638'; //d685739bf1 chỉ là ví dụ, bạn hãy thay bằng mật khẩu của bạn
