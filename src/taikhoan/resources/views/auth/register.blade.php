...
<head>
    ...
    <link rel="stylesheet" href="/frontend/vendor.css">
    ...
    <div class="register-box-body">
        ...
        <form method="post" action="{{ url('/register') }}">
            ...
            <div class="form-group has-feedback{{ $errors->has('name') ? ' has-error' : '' }}">
                <input type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="Tên đăng nhập">
            ...
            <div class="row" style="margin-top: 20px;">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox"> Đồng ý với các <a href="#">điều khoản</a>
                        </label>
                    </div>
                </div>
                <!-- /.col -->
        ...
        <a href="{{ url('/login') }}" class="text-center">Tôi đã có tài khoản rồi.</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
